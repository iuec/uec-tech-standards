...
### Assumptions
-   System suppliers should use a standardised mechanism to identify patients, it is anticipated that the systems will use the <a href="https://developer.nhs.uk/apis/uec-tech-standards/personal_demographics_service.html">Personal Demographics Service (PDS)</a> to uniquely identify the patient and link them to their available care records.
