...
o   Automated pre-population of data fields.
o   Automatic answering of questions.
o   Supporting local policy; e.g. triggering of system rules and alerts for actions such as re-routing or escalation of patient cases for clinical consultation.
o   Supporting local standard operating procedures for condition management, e.g. chronic condition management, and medication reviews.
...
##2.1 Basic Flow
`Table`
Test github markdown First Header | Second Header
------------ | -------------
...
Ref | Title  | Link
----|--------|-------
|Integrated Urgent Care Service Specification  |  https://www.england.nhs.uk/wp-content/uploads/2014/06/Integrated-Urgent-Care-Service-Specification.pdf
|NHS Digital data dictionary | http://www.datadictionary.nhs.uk
...
|Only authorized clinicians can trigger the CDSS to access and consume GP held Patient Data.| https://www.england.nhs.uk/contact-us/pub-scheme/pol-proc/
|Patient Data may only be viewed and utilized in direct patient care |https://www.england.nhs.uk/contact-us/pub-scheme/pol-proc/
|Patient consent must be obtained before the system can access and consume patient information. | https://www.england.nhs.uk/contact-us/pub-scheme/pol-proc/
|NHS England Data Protection Policy | https://www.england.nhs.uk/wp-content/uploads/2016/12/data-protection-policy-v3-1.pdf
