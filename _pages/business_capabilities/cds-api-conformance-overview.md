...
The API service being assured is the technical interaction between an Encounter Management System (EMS) and a Clinical Decision Support System (CDSS) using [FHIR](http://www.hl7.org/fhir/STU3/summary.html) as detailed in the [CDS API Implementation Guide](https://developer.nhs.uk/apis/cds-api/). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTc1OTU5OTc3LDc5Mjk4MjAxMCwxODk1MT
kwNjgwLDUxMTg5MTY2NV19
-->